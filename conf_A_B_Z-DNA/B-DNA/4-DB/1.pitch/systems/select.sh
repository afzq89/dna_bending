...
sed "s/COORD1/$coord1/g;s/COORD2/$coord2/g;s/AXIS1/$axis1/g;s/AXIS2/$axis3/g;s/AXIS3/$axis2/g" ../cv-pmd.in > cv-pmd$j.in
sed "s/AXIS3/$axis2/g" ../cv-smd.in > cv-smd$j.in
done
